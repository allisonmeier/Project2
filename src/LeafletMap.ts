...
class LeafletMap<T extends MapData>
{
    /** this is the base map layer, where we are showing the map background. */
    private baseLayer = createTileLayer(FreeTileLayers.StamenTerrain);

    private map: L.Map;
    private svg: d3.Selection<d3.BaseType, unknown, null, undefined>;
    private dots: d3.Selection<SVGCircleElement, T, d3.BaseType, unknown>;
    ...
    public constructor(
        ...
        this.dots = this.svg.selectAll('.call-marker').data(this.data).join('circle')
            ...
            }) as d3.Selection<SVGCircleElement, T, d3.BaseType, unknown>;
